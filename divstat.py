...
sim ='lindp2K_500tr_neuconv1' #'lindp2K_500tr_neu3' #'lindp2K_500tr_neuconv1' #'lindp2K_divUCP'
#est1plus4K/' #'lindp2K_fin' #test1plus4K_fin3' #lindp2K_fin' #
...
ax[0].plot(agedivcum.keys(),agedivcum.values(), linewidth=3.0,label='D > 2.5 $\mathregular{ms^{-1}}$',color='seagreen')
...
ax[1].set_xlabel('duration of precipitation track/ 5 min ')
#ax[1].set_ylabel('|D| / g $\mathregular{m^{-2}}$ $\mathregular{s^{-1}}$')
ax[1].set_ylabel('|D| / $\mathregular{ms^{-1}}$')
...
fig.savefig('plots/conv_div_lindp2K_'+sim+'.pdf')
#plt.show() 
